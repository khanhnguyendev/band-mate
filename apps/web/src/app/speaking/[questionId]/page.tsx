...
import { SpeakingEditor } from '@/components/speaking/speaking-editor'

interface Props {
  params: Promise<{ questionId: string }>
}

export default async function SpeakingEditorPage({ params }: Props) {
